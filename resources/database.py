...
'''
本程序的目的是从文件中读取一些数据，然后构造database
...
print("The type of database is: %s" % type(database))
...
# form.
STREETS_FNAME = "./data/streets.expanded.txt"
STOPS_FNAME = "./data/stops.expanded.txt"
BOROUGHS_FNAME = "./data/boroughs.expanded.txt"
CITIES_FNAME = "./data/cities.expanded.txt"
STATES_FNAME = "./data/states.expanded.txt"
...
if __name__ == '__main__':
    for sv in database.get('street', tuple()):
        print(sv)
